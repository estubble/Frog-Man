...
class tomokoSnake(pygame.sprite.Sprite):
	def __init__(self, startX, startY):
		self.x = startX 
		self.y = startY
		self.sprite_sheet_image = pygame.image.load('tomokoSnake.png').convert_alpha()
		...
		self.walk_frames.append(self.sprite_sheet.getImage(self.sprite_sheet_image, 0, 32, 32, BLACK, 4))
		...
		self.hurt_frame = self.sprite_sheet.getImage(self.sprite_sheet_image, 4, 32, 32, BLACK, 4)
		
		self.death_frame = self.sprite_sheet.getImage(self.sprite_sheet_image, 5, 32, 32, BLACK, 4)
